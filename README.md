...
* Установка через F-Droid
  > Устанавливаете приложение с [сайта](https://f-droid.org).
  > Открываете и ищете в поиске Termux.
  > Устанавливаете и запускаете.
  > Готово.
* Установка с [4PDA](https://4pda.to/forum/index.php?showtopic=741456)
  > Выбираете и устанавливаете нужную вам версию.
  > Готово.
